		...
		if($check_subject === 0){
			...
			echo 	'<div class="alert alert-success">  
				...
				echo '<div class="alert alert-block">  
					<a class="close" data-dismiss="alert">X</a>  
					<strong>Oops Error!</strong>Not Added.  
					</div>';  
			}
		}
		else{
			echo '<div class="alert alert-block">  
					<a class="close" data-dismiss="alert">X</a>  
					<strong>Oops Error!</strong>Subject Already Exists.  
					</div>'; 			
		}
  ...
  <div class="row">
    <div class="col-lg-6">
		<div class="jumbotron">
				...
				<!-- Text input-->
				<div class="form-group">
				  <label class="col-md-4 control-label" for="l">Total Lecture credits</label>  
				  <div class="col-md-8">
				  <input id="l" name="l" type="text" placeholder="L" class="form-control input-md" required="">
				  <span class="help-block">Total theory paper credits for this subject(excluding quizes)</span>  
				  </div>
				</div>

				<!-- Text input-->
				<div class="form-group">
				  <label class="col-md-4 control-label" for="t">Total Quiz credits</label>  
				  <div class="col-md-8">
				  <input id="t" name="t" type="text" placeholder="T" class="form-control input-md" required="">
				  <span class="help-block">Total credits for quiz in this subject</span>  
				  </div>
				</div>

				<!-- Text input-->
				<div class="form-group">
				  <label class="col-md-4 control-label" for="p">Total Practical credits</label>  
				  <div class="col-md-8">
				  <input id="p" name="p" type="text" placeholder="P" class="form-control input-md" required="">
				  <span class="help-block">Total Practical credits for this subject</span>  
				  </div>
				</div>
