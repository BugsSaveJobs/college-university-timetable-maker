		...
		<form class="form-horizontal" method= "post" action = "">
			...
			<!-- Text input-->
				<div class="form-group">
				  <label class="col-md-4 control-label" for="name">Course Pursuing</label>  
				  <div class="col-md-8">
			...
			<!-- Text input-->
				<div class="form-group">
				  <label class="col-md-4 control-label" for="name">Branch Name</label>  
				  <div class="col-md-8">
			...
			<!-- Select Basic -->
			<div class="form-group">
			  <label class="col-md-4 control-label" for="faculty">Subject Instructor</label>
			  <div class="col-md-8">
